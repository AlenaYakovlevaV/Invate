...
export const User = ({ id, email, first_name, last_name, avatar, onClickInvite, isIvited}) => (
  <li>
    <div>
      ...
      <div>
        ...
        <p>
          ...
          <a href='#' onClick={() => {window.location.href = "mailto:" + email}}>
            {email}
          </a>
        </p>
      </div>
    ...
    <img 
      ...
      className="action" 
      src={`/assets/${isIvited ? 'minus' : 'plus'}.svg`} 
      alt="Action" 
    />
  </li>
);